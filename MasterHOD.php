...
<div class="topnav" id="myTopnav">
    ...
    <div class="sidebar">
        ...
        <a href="HoDDashboard.php"><i class='bx bx-home'></i> <span class="link-text">Dashboard</span></a>
        <a href="AccountUpdate.php"><i class='bx bx-user'></i> <span class="link-text">Account Update</span></a>
        <a href="Approval.php"><i class='bx bx-list-ol'></i><span class="link-text">Manage Requests</span></a>
        <a href="ViewApprovals.php"><i class='bx bxs-user-detail'></i> <span class="link-text">View Approvals</span></a>
        <a href="#my-payments"><i class='bx bx-credit-card'></i> <span class="link-text">My Payments</span></a>
